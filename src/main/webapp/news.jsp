...
<div class="menu-bar">     
	...
	<div class="container">
		<h2>커뮤니티 글 작성하기</h2>
		<form action="writeCommunityAction.jsp" method="post">
		
			<div class="form-group">
			<label for="title">글 제목</label> 
			<input type="text"
					class="form-control" id="title" placeholder="입력(4-100)"
					name="communityTitle" maxlength="100" required="required" pattern=".{4,100}">
					
				<label for="content">내용</label>
				<textarea class="form-control" rows="10" id="content" name="communityContent"
    ...
    *음란물, 성적 수치심을 유발하는 행위 금지"></textarea>
			</div>
